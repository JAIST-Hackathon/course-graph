...
const syllabusCsvFilePath = '../../public/jaist_syllabus_cs_ishikawa_2025.csv'
// 講義間の関係は
const relationCsvFilePath = '../../public/class_relation.csv';
...
function displayGraph(nodes = nodesAllGlobal, edges = edgesGlobal) {
    ...
    let options = {
        interaction: {
            navigationButtons: true, keyboard: true, scaling: {
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    selectElement.addEventListener("change", function () {
        ...
        // 講義に関連している講義を抽出
        let connectedNodesToNode = getConnectedNodesToNode(selectedCode);
